...
# run seq-gen
def seqgen(mode, params, out_fn, config, GLOBAL):
...
def seqgen_gtr(params, out_fn, config, GLOBAL):
    seqgen("GTR", params, out_fn, config, GLOBAL)
def seqgen_gtr_codon(params, out_fn, config, GLOBAL):
    seqgen("GTR+Codon", params, out_fn, config, GLOBAL)
def seqgen_gtr_gamma(params, out_fn, config, GLOBAL):
    seqgen("GTR+G", params, out_fn, config, GLOBAL)
