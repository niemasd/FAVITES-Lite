...
def coatran(exe, params, out_fn, config, GLOBAL):
...
def coatran_constant(params, out_fn, config, GLOBAL):
    coatran("coatran_constant", params, out_fn, config, GLOBAL)
def coatran_inftime(params, out_fn, config, GLOBAL):
    coatran("coatran_inftime", params, out_fn, config, GLOBAL)
def coatran_transtree(params, out_fn, config, GLOBAL):
    coatran("coatran_transtree", params, out_fn, config, GLOBAL)
