...
def treeswift_autocorr_const_inc(params, out_fn, config, GLOBAL):
...
def treeswift_autocorr_exp(params, out_fn, config, GLOBAL):
    tree = read_tree_newick(out_fn['viral_phylogeny_time'])
    for node in tree.traverse_preorder():
        if node.is_root():
            node.rate = params['R0']
...
def treeswift_autocorr_gamma(params, out_fn, config, GLOBAL):
...
def treeswift_autocorr_lognorm(params, out_fn, config, GLOBAL):
    tree = read_tree_newick(out_fn['viral_phylogeny_time']); v = params['v']
    for node in tree.traverse_preorder():
        if node.is_root():
            node.rate = params['R0']
...
# Constant
def treeswift_constant(params, out_fn, config, GLOBAL):
...
# Chi-Squared
def treeswift_chisq(params, out_fn, config, GLOBAL):
...
# Exponential
def treeswift_exp(params, out_fn, config, GLOBAL):
...
# F
def treeswift_f_dist(params, out_fn, config, GLOBAL):
...
# Gamma
def treeswift_gamma(params, out_fn, config, GLOBAL):
...
def treeswift_inverse_gaussian(params, out_fn, config, GLOBAL):
...
# Log-Normal
def treeswift_lognorm(params, out_fn, config, GLOBAL):
...
def treeswift_noncentral_chisq(params, out_fn, config, GLOBAL):
...
# Noncentral F
def treeswift_noncentral_f(params, out_fn, config, GLOBAL):
...
# Pareto
def treeswift_pareto(params, out_fn, config, GLOBAL):
...
# Power
def treeswift_power(params, out_fn, config, GLOBAL):
...
# Rayleigh
def treeswift_rayleigh(params, out_fn, config, GLOBAL):
...
# Triangular
def treeswift_triangular(params, out_fn, config, GLOBAL):
...
# Truncated Normal
def treeswift_truncnorm(params, out_fn, config, GLOBAL):
...
# Uniform
def treeswift_uniform(params, out_fn, config, GLOBAL):
...
# Weibull
def treeswift_weibull(params, out_fn, config, GLOBAL):
