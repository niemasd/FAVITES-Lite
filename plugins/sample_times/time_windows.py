...
def time_windows(model, params, out_fn, config, GLOBAL):
...
def time_windows_trunc_expon(params, out_fn, config, GLOBAL):
    time_windows("Truncated Exponential", params, out_fn, config, GLOBAL)
def time_windows_trunc_gamma(params, out_fn, config, GLOBAL):
    time_windows("Truncated Gamma", params, out_fn, config, GLOBAL)
def time_windows_trunc_normal(params, out_fn, config, GLOBAL):
    time_windows("Truncated Normal", params, out_fn, config, GLOBAL)
def time_windows_uniform(params, out_fn, config, GLOBAL):
    time_windows("Uniform", params, out_fn, config, GLOBAL)
